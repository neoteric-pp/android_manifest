...
```
repo init -u git@github.com:neoteric-pp/android_manifest.git -b bka
```
Alternateively, shallow clone everything to save a lot of space,
```
repo init --depth=1 -u git@github.com:neoteric-pp/android_manifest.git -b bka
```

If you are a maintainer you need to use:
```
repo init -u git@github.com:neoteric-pp/android_manifest.git -g all -b bka
```
Or to save space just as above :
```
repo init --depth=1 -u git@github.com:neoteric-pp/android_manifest.git -g all -b bka
```
